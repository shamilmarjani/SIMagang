...
<head>
    ...
    <title>Pendaftaran Magang - SIMM</title>
    <!-- Use Google Fonts -->
    ...
    <style>
        ...
        .maps-wrapper {
            ...
            margin-top: 6px;
            box-shadow: 0 2px 8px rgba(28, 51, 77, 0.08);
        }
        ...
        .member-panel-title {
            ...
            padding: 10px 14px;
            background: #F5F8FF;
            border-left: 3px solid #1C334D;
            border-radius: 0 6px 6px 0;
        }

        .member-panel-title em {
            font-weight: 400;
            color: #778;
        }
    </style>
...
<body>
    <div class="dashboard-layout">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                <a href="dashboard.php" class="nav-item">Dashbord</a>
                ...
                <div class="card-body p-0" style="padding: 25px; background: white;">
                    ...
                    <div id="accordion">
                        ...
                        <div class="tahap-container active" id="step-1">
                            <div class="t-header t-header-dark" id="header-1">Tahap 1 : Lokasi magang</div>

                            <!-- Form -->
                            <div class="t-body t-form" id="form-1">
                                <form class="profile-form" id="form-el-1">
                                    <div class="form-row">
                                        <div class="form-group">
                                            <label>Perusahaan <span style="color:#EA5455">*</span></label>
                                            <input type="text" id="inp-perusahaan" placeholder="Nama perusahaan">
                                        </div>
                                        <div class="form-group">
                                            <label>Nama Pimpinan <span style="color:#EA5455">*</span></label>
                                            <input type="text" id="inp-pimpinan"
                                                placeholder="Nama pimpinan / contact person">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group">
                                            <label>Bidang <span style="color:#EA5455">*</span></label>
                                            <input type="text" id="inp-bidang" placeholder="Bidang perusahaan">
                                        </div>
                                        <div class="form-group">
                                            <label>Telepon <span style="color:#EA5455">*</span></label>
                                            <input type="text" id="inp-telepon" placeholder="Nomor telepon">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group">
                                            <label>Alamat <span style="color:#EA5455">*</span></label>
                                            <input type="text" id="inp-alamat" placeholder="Alamat lengkap perusahaan"
                                                oninput="debounceMapUpdate()">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" style="margin-top: 14px;">
                                        ...
                                        <div class="maps-coord-row">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="inp-lat" placeholder="Contoh: -7.9666" readonly
                                                    style="background:#F8F9FA;">
                                            </div>
                                            <div class="form-group">
                                                <label>Longitude</label>
                                                <input type="text" id="inp-lng" placeholder="Contoh: 112.6326" readonly
                                                    style="background:#F8F9FA;">
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-actions">
                                        <button type="button" class="btn btn-dark" onclick="nextStep(1)">Simpan &amp;
                                            Lanjut</button>
                                    </div>
                                </form>
                            </div>
                            ...
                            <!-- Completed -->
                            <div class="t-body t-completed" id="completed-1" style="display: none;">
                                <div class="completed-grid">
                                    <div>
                                        <p>Perusahaan: <strong id="v-perusahaan">-</strong></p>
                                        <p>Bidang: <strong id="v-bidang">-</strong></p>
                                        <p>Alamat: <strong id="v-alamat">-</strong></p>
                                        <p>Koordinat: <strong id="v-koordinat">-</strong></p>
                                    </div>
                                    <div>
                                        <p>Contact Person: <strong id="v-pimpinan">-</strong></p>
                                        <p>Telepon: <strong id="v-telepon">-</strong></p>
                                        <p>Status: <span class="badge badge-warning">Menunggu Verifikasi</span></p>
                                    </div>
                                </div>
                        ...
                        <!-- Tahap 2 -->
                        <div class="tahap-container locked" id="step-2">
                            <div class="t-header t-header-white" id="header-2">Tahap 2 : Proposal Kelompok</div>

                            <div class="t-body t-form" id="form-2" style="display: none;">
                                <form class="profile-form" id="form-el-2">
                                    <div class="form-group">
                                        <label>Judul Proposal <span style="color:#EA5455">*</span></label>
                                        <input type="text" id="inp-judul" placeholder="Masukkan judul proposal">
                                    </div>
                                    <div class="form-group">
                                        <label>File Proposal (PDF) <span style="color:#EA5455">*</span></label>
                                        <div style="display: flex; gap: 10px;">
                                            <input type="file" id="file-tahap2" accept=".pdf" style="display: none;"
                                            ...
                                            <button type="button" class="btn btn-dark"
                                                ...
                                                File</button>
                                            <input type="text" id="filename-tahap2" style="flex: 1;" readonly
                                    ...
                                    <div class="form-actions">
                                        <button type="button" class="btn btn-dark" onclick="nextStep(2)">Simpan &amp;
                                            Lanjut</button>
                                    </div>
                                </form>
                            </div>

                            <div class="t-body t-completed" id="completed-2" style="display: none;">
                                <div class="completed-grid">
                                    <div>
                                        <p>Judul Proposal: <strong id="v-judul">-</strong></p>
                                        <p>File: <strong id="v-file-proposal">-</strong></p>
                                        <p>Status: <span class="badge badge-warning">Menunggu Verifikasi</span></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- Tahap 3 -->
                        <div class="tahap-container locked" id="step-3">
                            <div class="t-header t-header-white" id="header-3">Tahap 3 : Berkas Anggota</div>

                            <div class="t-body t-form" id="form-3" style="display: none;">

                                <!-- Tab Member -->
                                <div class="member-tabs" id="member-tabs">
                                    <button type="button" class="member-tab active" id="mtab-0"
                                        onclick="switchMemberTab(0)">&#128100; Sultan <span class="mtab-status"
                                            id="mstatus-0"></span></button>
                                    <button type="button" class="member-tab" id="mtab-1"
                                        onclick="switchMemberTab(1)">&#128100; Budi <span class="mtab-status"
                                            id="mstatus-1"></span></button>
                                    <button type="button" class="member-tab" id="mtab-2"
                                        onclick="switchMemberTab(2)">&#128100; Ani <span class="mtab-status"
                                            id="mstatus-2"></span></button>
                                </div>

                                <!-- Panel Anggota 0: Sultan -->
                                <div class="member-panel" id="mpanel-0">
                                    <div class="member-panel-title">Sultan &mdash; <em>Ketua Kelompok</em></div>
                                    <form class="profile-form">
                                        <div class="form-row">
                                            <div class="form-group">
                                                <label>Formulir Pendaftaran</label>
                                                <input type="file" id="file-m0-1" style="display:none"
                                                    onchange="setFile('m0-1', this); updateMemberStatus(0)">
                                                <input type="text" id="fn-m0-1" readonly
                                                    placeholder="Klik untuk pilih file"
                                                    onclick="document.getElementById('file-m0-1').click()"
                                                    style="cursor:pointer">
                                            </div>
                                            <div class="form-group">
                                                <label>Scan KTM</label>
                                                <input type="file" id="file-m0-2" style="display:none"
                                                    onchange="setFile('m0-2', this); updateMemberStatus(0)">
                                                <input type="text" id="fn-m0-2" readonly
                                                    placeholder="Klik untuk pilih file"
                                                    onclick="document.getElementById('file-m0-2').click()"
                                                    style="cursor:pointer">
                                            </div>
                                            <div class="form-group">
                                                <label>Transkrip Nilai</label>
                                                <input type="file" id="file-m0-3" style="display:none"
                                                    onchange="setFile('m0-3', this); updateMemberStatus(0)">
                                                <input type="text" id="fn-m0-3" readonly
                                                    placeholder="Klik untuk pilih file"
                                                    onclick="document.getElementById('file-m0-3').click()"
                                                    style="cursor:pointer">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group">
                                                ...
                                                <input type="file" id="file-m0-4" accept="image/*" style="display:none"
                                                    onchange="setFile('m0-4', this); updateMemberStatus(0)">
                                                <input type="text" id="fn-m0-4" readonly
                                                    placeholder="Klik untuk pilih file"
                                                    onclick="document.getElementById('file-m0-4').click()"
                                                    style="cursor:pointer">
                                            </div>
                                            <div class="form-group">
                                                <label>CV</label>
                                                <input type="file" id="file-m0-5" style="display:none"
                                                    onchange="setFile('m0-5', this); updateMemberStatus(0)">
                                                <input type="text" id="fn-m0-5" readonly
                                                    placeholder="Klik untuk pilih file"
                                                    onclick="document.getElementById('file-m0-5').click()"
                                                    style="cursor:pointer">
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <!-- Panel Anggota 1: Budi -->
                                <div class="member-panel" id="mpanel-1" style="display:none">
                                    <div class="member-panel-title">Budi &mdash; <em>Anggota</em></div>
                                    <form class="profile-form">
                                        <div class="form-row">
                                            <div class="form-group">
                                                <label>Formulir Pendaftaran</label>
                                                <input type="file" id="file-m1-1" style="display:none"
                                                    onchange="setFile('m1-1', this); updateMemberStatus(1)">
                                                <input type="text" id="fn-m1-1" readonly
                                                    placeholder="Klik untuk pilih file"
                                                    onclick="document.getElementById('file-m1-1').click()"
                                                    style="cursor:pointer">
                                            </div>
                                            <div class="form-group">
                                                <label>Scan KTM</label>
                                                <input type="file" id="file-m1-2" style="display:none"
                                                    onchange="setFile('m1-2', this); updateMemberStatus(1)">
                                                <input type="text" id="fn-m1-2" readonly
                                                    placeholder="Klik untuk pilih file"
                                                    onclick="document.getElementById('file-m1-2').click()"
                                                    style="cursor:pointer">
                                            </div>
                                            <div class="form-group">
                                                <label>Transkrip Nilai</label>
                                                <input type="file" id="file-m1-3" style="display:none"
                                                    onchange="setFile('m1-3', this); updateMemberStatus(1)">
                                                <input type="text" id="fn-m1-3" readonly
                                                    placeholder="Klik untuk pilih file"
                                                    onclick="document.getElementById('file-m1-3').click()"
                                                    style="cursor:pointer">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group">
                                                <label>Pas Foto</label>
                                                <input type="file" id="file-m1-4" accept="image/*" style="display:none"
                                                    onchange="setFile('m1-4', this); updateMemberStatus(1)">
                                                <input type="text" id="fn-m1-4" readonly
                                                    placeholder="Klik untuk pilih file"
                                                    onclick="document.getElementById('file-m1-4').click()"
                                                    style="cursor:pointer">
                                            </div>
                                            <div class="form-group">
                                                <label>CV</label>
                                                <input type="file" id="file-m1-5" style="display:none"
                                                    onchange="setFile('m1-5', this); updateMemberStatus(1)">
                                                <input type="text" id="fn-m1-5" readonly
                                                    placeholder="Klik untuk pilih file"
                                                    onclick="document.getElementById('file-m1-5').click()"
                                                    style="cursor:pointer">
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <!-- Panel Anggota 2: Ani -->
                                <div class="member-panel" id="mpanel-2" style="display:none">
                                    <div class="member-panel-title">Ani &mdash; <em>Anggota</em></div>
                                    <form class="profile-form">
                                        <div class="form-row">
                                            <div class="form-group">
                                                <label>Formulir Pendaftaran</label>
                                                <input type="file" id="file-m2-1" style="display:none"
                                                    onchange="setFile('m2-1', this); updateMemberStatus(2)">
                                                <input type="text" id="fn-m2-1" readonly
                                                    placeholder="Klik untuk pilih file"
                                                    onclick="document.getElementById('file-m2-1').click()"
                                                    style="cursor:pointer">
                                            </div>
                                            <div class="form-group">
                                                <label>Scan KTM</label>
                                                <input type="file" id="file-m2-2" style="display:none"
                                                    onchange="setFile('m2-2', this); updateMemberStatus(2)">
                                                <input type="text" id="fn-m2-2" readonly
                                                    placeholder="Klik untuk pilih file"
                                                    onclick="document.getElementById('file-m2-2').click()"
                                                    style="cursor:pointer">
                                            </div>
                                            <div class="form-group">
                                                <label>Transkrip Nilai</label>
                                                <input type="file" id="file-m2-3" style="display:none"
                                                    onchange="setFile('m2-3', this); updateMemberStatus(2)">
                                                <input type="text" id="fn-m2-3" readonly
                                                    placeholder="Klik untuk pilih file"
                                                    onclick="document.getElementById('file-m2-3').click()"
                                                    style="cursor:pointer">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group">
                                                <label>Pas Foto</label>
                                                <input type="file" id="file-m2-4" accept="image/*" style="display:none"
                                                    onchange="setFile('m2-4', this); updateMemberStatus(2)">
                                                <input type="text" id="fn-m2-4" readonly
                                                    placeholder="Klik untuk pilih file"
                                                    onclick="document.getElementById('file-m2-4').click()"
                                                    style="cursor:pointer">
                                            </div>
                                            <div class="form-group">
                                                <label>CV</label>
                                                <input type="file" id="file-m2-5" style="display:none"
                                                    onchange="setFile('m2-5', this); updateMemberStatus(2)">
                                                <input type="text" id="fn-m2-5" readonly
                                                    placeholder="Klik untuk pilih file"
                                                    onclick="document.getElementById('file-m2-5').click()"
                                                    style="cursor:pointer">
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="form-actions" style="margin-top:16px;">
                                    <button type="button" class="btn btn-dark" onclick="nextStep(3)">Simpan &amp;
                                        Lanjut</button>
                                </div>
                            </div>

                            <!-- Completed -->
                            <div class="t-body t-completed" id="completed-3" style="display: none;">
                                <div id="v-berkas-summary"></div>
                                <p style="margin-top:10px">Tanggal Upload: <strong id="v-tgl-berkas">-</strong></p>
                                <p style="margin-top:6px">Status: <span class="badge badge-warning">Menunggu
                                        Verifikasi</span></p>
                            </div>
                        </div>

                        <!-- Tahap 4 -->
                        <div class="tahap-container locked" id="step-4">
                            <div class="t-header t-header-white" id="header-4">Tahap 4 : Bukti Diterima</div>

                            <div class="t-body t-form" id="form-4" style="display: none;">
                                <form class="profile-form" id="form-el-4">
                                    <div class="form-group">
                                        <label>Tempat Diterima <span style="color:#EA5455">*</span></label>
                                        <input type="text" id="inp-tempat"
                                            placeholder="Nama perusahaan / instansi yang menerima">
                                    </div>
                                    <div class="form-group">
                                        <label>Surat Penerimaan (PDF) <span style="color:#EA5455">*</span></label>
                                        <div style="display: flex; gap: 10px;">
                                            <input type="file" id="file-tahap4" accept=".pdf,.jpg,.png"
                                                style="display: none;"
                                            ...
                                            <button type="button" class="btn btn-dark"
                                                ...
                                                File</button>
                                            <input type="text" id="filename-tahap4" style="flex: 1;" readonly
                                    ...
                                    <div class="form-actions">
                                        <button type="button" class="btn btn-dark" onclick="nextStep(4)">Simpan &amp;
                                            Lanjut</button>
                                    </div>
                                </form>
                            </div>

                            <div class="t-body t-completed" id="completed-4" style="display: none;">
                                <div class="completed-grid">
                                    <div>
                                        <p>Tempat Diterima: <strong id="v-tempat">-</strong></p>
                                        <p>File: <strong id="v-file-bukti">-</strong></p>
                                        <p>Tanggal Upload: <strong id="v-tgl-bukti">-</strong></p>
                                        <p>Status: <span class="badge badge-warning">Menunggu Verifikasi</span></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- Tahap 5 -->
                        <div class="tahap-container locked" id="step-5">
                            <div class="t-header t-header-white" id="header-5">Tahap 5 : Plotting Dosen</div>

                            <div class="t-body t-form" id="form-5" style="display: none;">
    ...
    <script>
        ...
        function isiCompleted(step) {
            ...
            if (step === 3) {
                const members = ['Sultan', 'Budi', 'Ani'];
                const berkasLabels = ['Formulir', 'Scan KTM', 'Transkrip', 'Pas Foto', 'CV'];
                let allHaveFile = true;
                let summaryHTML = '';

                members.forEach((nama, mi) => {
                    const files = [1, 2, 3, 4, 5].map(fi => ({
                        label: berkasLabels[fi - 1],
                        name: document.getElementById(`fn-m${mi}-${fi}`)?.value.trim() || ''
                    }));
                    const uploaded = files.filter(f => f.name);
                    if (uploaded.length === 0) allHaveFile = false;

                    const role = mi === 0 ? 'Ketua' : 'Anggota';
                    const icon = uploaded.length === 5 ? '&#10003;' : uploaded.length > 0 ? '&#9888;' : '&#10007;';
                    const color = uploaded.length === 5 ? '#28C76F' : uploaded.length > 0 ? '#FF9F43' : '#EA5455';
                    summaryHTML += `
                        <div style="margin-bottom:12px;padding:12px 16px;background:#F8FBFF;border:1px solid #EEF3F8;border-radius:8px;">
                            <strong style="color:${color}">${icon} ${nama}</strong> <em style="color:#888;font-size:12px">(${role})</em>
                            <span style="float:right;font-size:12px;color:${color};font-weight:600">${uploaded.length}/5 berkas</span>
                            <div style="font-size:12px;color:#666;margin-top:6px;">
                                ${uploaded.length > 0 ? uploaded.map(f => '&#128196; ' + f.label + ': ' + f.name).join('<br>') : '<em>Belum ada berkas diupload</em>'}
                            </div>
                        </div>
                    `;
                });
                ...
                document.getElementById('v-berkas-summary').innerHTML = summaryHTML;
                document.getElementById('v-tgl-berkas').textContent = hariIni();
                return true;
            }
            if (step === 4) {
        ...
        function switchMemberTab(idx) {
            [0, 1, 2].forEach(i => {
                ...
                document.getElementById('mpanel-' + i).style.display = i === idx ? '' : 'none';
            });
        }
